...
with tf.Session() as sess:
    ...
    for iteration in range(max_iterations):
        ...
        actions = OrderedDict()
        actions["agent1"] = OrderedDict()
        actions["agent1"][asset] = OrderedDict()
        actions["agent1"][asset]["action"] = action_considered
        actions["agent1"][asset]["price"] = None
        actions["agent1"][asset]["volume"] = 50
        actions["agent1"][asset]["limit_min"] = None
        actions["agent1"][asset]["limit_max"] = None
        actions["agent1"][asset]["order_type"] = "market"
        actions["agent1"][asset]["time"] = time()
